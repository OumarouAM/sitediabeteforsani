...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/sensibilisationss/**").permitAll();
		http.authorizeRequests().antMatchers("/depistagess/**").permitAll();
		http.authorizeRequests().antMatchers("/soinss/**").permitAll();
		http.authorizeRequests().antMatchers("/formationss/**").permitAll();
		http.authorizeRequests().antMatchers("/galleryss/**").permitAll();
		http.authorizeRequests().antMatchers("/contactss/**").permitAll();
